    ...
    return (
        <div className="p-4 bg-blue-50 border-2 border-brand-gold rounded-lg text-center shadow-md mt-6">
            ...
            {isLoading ? (
                ...
                <p className="text-4xl font-bold text-brand-navy my-2">${estimate.price.toLocaleString()} <span className="text-xl font-semibold">/{estimate.per}</span></p>
            ) : (
                 <p className="text-gray-600 my-4">Complete the form to see an estimate.</p>
            )}
             <p className="text-xs text-gray-500 mt-2">A final quote will be provided after a consultation. This is an AI-generated estimate.</p>
        </div>
    );
};
