        ...
        <div className="lg:w-[400px] bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
          ...
          <div className="relative mb-4">
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-[#0071e3] focus:border-transparent text-gray-900 bg-white placeholder-gray-400"
            />
              ...
              <div className="mb-6">
                {!isAddingNote ? (
                  <button
                    ...
                    className="w-full py-3 text-gray-700 bg-white border border-gray-300 rounded-xl hover:bg-gray-100 transition-colors font-semibold"
                  >
                    + Add Note
                  </button>
                ) : (
